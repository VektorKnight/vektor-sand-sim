    ...
    public static class MaterialTable {
        ...
        private static readonly List<MaterialDefinition> _materials = new() {
            ...
            new() {
                ...
                Variation = 0.15f,
                Color = new Color(0.28f, 0.26f, 0.32f, 1f),
            },
            new() {
                ...
                Variation = 0.25f,
                Color = new Color(0.42f, 0.38f, 0.35f, 1f),
            },
            new() {
                ...
                Variation = 0.1f,
                Color = new Color(0.7f, 0.85f, 0.9f, 0.01f),
            },
            new() {
                ...
                Variation = 0.3f,
                Color = new Color(0.45f, 0.28f, 0.12f, 1f),
            },
            new() {
                ...
                Variation = 0.5f,
                Color = new Color(0.4f, 0.75f, 0.85f, 0.06f),
            },
            // Powders
            new() {
                ...
                Variation = 0.5f,
                Color = new Color(0.8207547f, 0.5865165f, 0.32907617f, 0.7f),
            },
            new() {
            ...
            new() {
                ...
                Variation = 0.5f,
                Color = new Color(0.75f, 0.84f, 0.95f, 0.04f),
            },
            new() {
                ...
                Variation = 0.15f,
                Color = new Color(0.27f, 0.25f, 0.22f, 1f),
            },
            ...
            new() {
                ...
                Variation = 0.1f,
                Color = new Color(0.14509802f, 0.36678076f, 0.7921569f, 0.01f),
            },
            new() {
                ...
                Variation = 0.1f,
                Color = new Color(0.43529412f, 0.29143146f, 0.23529412f, 0.1f),
            },
            new() {
                ...
                Color = new Color(0.3f, 0.85f, 0.15f, 0.08f),
            },
            new() {
                ...
                Color = new Color(0.75f, 0.12f, 0.02f, 0.4f),
            },
            ...
            new() {
                ...
                Fluidity = 64, Density = 5, Weight = -16, Drag = 120,
                InitialTemp = 800f, Conductivity = 0.8f, HeatCapacity = 4f,
                Variation = 0.8f,
                EmissionColor = new Color(1f, 0.8f, 0.1f),
                EmissionIntensity = 2f,
                Color = new Color(1f, 0.35f, 0f, 0.05f),
            },
            new() {
                ...
                Color = new Color(0.8f, 0.25f, 0.02f, 0.3f),
            },
            new() {
                ...
                Color = new Color(0.4f, 0.3f, 0.9f, 0.03f),
            },
            ...
            new() {
                ...
                Fluidity = 64, Density = 10, Weight = -32, Drag = 190,
                InitialTemp = 100f, Conductivity = 0.04f, HeatCapacity = 0.5f,
                Variation = 0.3f,
                Color = new Color(0.7f, 0.85f, 0.9f, 0.02f),
            },
            new() {
            ...
            new() {
                ...
                Variation = 0.4f,
                Color = new Color(0.15f, 0.45f, 0.1f, 0.04f),
            },
            new() {
            ...
            new() {
                ...
                Variation = 0.15f,
                Color = new Color(0.72f, 0.45f, 0.20f, 1f),
            },
            ...
            new() {
                ...
                Variation = 0.15f,
                Color = new Color(0.55f, 0.70f, 0.90f, 0.005f),
            }
        };
