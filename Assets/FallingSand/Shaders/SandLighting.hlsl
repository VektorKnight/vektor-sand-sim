...
cbuffer LightConfig {
    ...
    int2   LightDir;           // offset 32
    uint   LightMaxSteps;      // offset 40
    uint   LightDownscale;     // offset 44
    uint   EmissionMaxSteps;   // offset 48
    uint   BloomSteps;         // offset 52
    uint2  LightDimensions;    // offset 56
};                             // 64 bytes, no padding
